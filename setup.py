...
setup(
  name = 'Infrali74',         # How you named your package folder (MyLib)
  packages = ['Infrali74'],   # Chose the same as "name"
  ...
  keywords = ['Veinsdetecting', 'Python', 'Veinfinder', 'Veinlocator', 'Veindetection'],   # Keywords that define your package best
